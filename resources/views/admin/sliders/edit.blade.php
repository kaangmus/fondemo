                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $slider->description) }}</textarea>
                        ...
                        <div class="form-group col-md-4 {{ $errors->has('btn_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="btn_text" id="btn_text" value="{{ old('btn_text', $slider->btn_text) }}">
                        ...
                        <div class="form-group col-md-4{{ $errors->has('btn_link') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="btn_link" id="btn_link" value="{{ old('btn_link', $slider->btn_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date {{ $errors->has('published_at') ? 'is-invalid' : '' }}" type="text"
                                name="published_at" id="published_at" value="{{ old('published_at', $slider->published_at) }}">
                            @if($errors->has(''))
