        ...
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group link">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link"
                    value="{{ old('link', $contentPage->link) }}">
                @if($errors->has('link'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control my-editor {{ $errors->has('page_text') ? 'is-invalid' : '' }}" name="page_text" id="page_text">{!! old('page_text', $contentPage->page_text) !!}</textarea>
            ...
            <div class="form-group {{ $errors->has('video') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <span class="help-block">Only mp4</span>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('published_at') ? 'is-invalid' : '' }}" type="text"
                    name="published_at" id="published_at" value="{{ old('published_at', $contentPage->published_at) }}" required>
                @if($errors->has(''))
