                ...
                <tbody>
                    @foreach($contentPages as $key => $contentPage)
                        <tr data-entry-id="{{ $contentPage->id }}">
                            ...
                            <td>
                                <span class="badge badge-danger">{{ App\ContentPage::TYPE_SELECT[$contentPage->type] ?? '' }}</span>
                            </td>
                            <td>
                                @if($contentPage->link)
                                <a href="{{ $contentPage->link }}" target="_blank">
                                   link
                                </a>
                                @endif
                            ...
                            <td>
                                @if($contentPage->video)
                                                <a href="{{ $contentPage->video->getUrl() }}" target="_blank">
                                                    view video
                                                </a>
                                            @endif
                            </td>
                            ...
                            <td>
                                {{ date('d F Y',strtotime($contentPage->published_at)) ?? '' }}
                            </td>
                            <td>
