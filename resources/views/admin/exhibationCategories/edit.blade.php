...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.exhibationCategory.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.exhibation-categories.update", [$exhibationCategory->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('year') ? 'is-invalid' : '' }}" name="year_id" id="year_id" required>
                    @foreach($years as $id => $year)
                        <option value="{{ $id }}" {{ ($exhibationCategory->year ? $exhibationCategory->year->id : old('year_id')) == $id ? 'selected' : '' }}>{{ $year }}</option>
                    @endforeach
                </select>
                @if($errors->has('year'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $exhibationCategory->description) !!}</textarea>
           ...
           <div class="form-group {{ $errors->has('post') ? 'has-error' : '' }}">
            ...
            <div class="form-group {{ $errors->has('photo') ? 'has-error' : '' }}">
              <div>
                ...
                <input type="checkbox" name="photo" id="photo" value="1"
                  {{ $exhibationCategory->photo || old('photo', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('book') ? 'has-error' : '' }}">
              <div>
                ...
                <input type="checkbox" name="book" id="book" value="1"
                  {{ $exhibationCategory->book || old('book', 0) === 1 ? 'checked' : '' }}>
            ...
            <div  id="e_cat_post">
                ...
                <div class="form-group" style="{{$exhibationCategory->type == 'epost'?'':'display: none'}}">
                 ...
                 <div class="form-group">
                  ...
                  <input class="form-control date {{ $errors->has('public_date') ? 'is-invalid' : '' }}" type="text" name="public_date" id="public_date" value="{{ old('public_date', $exhibationCategory->public_date) }}">
