    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_nmae') ? 'is-invalid' : '' }}" type="text" name="first_nmae" id="first_nmae" value="{{ old('first_nmae', $user->first_nmae) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $user->fax) }}">
                @if($errors->has('fax'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('companyid') ? 'is-invalid' : '' }}" type="text" name="companyid" id="companyid" value="{{ old('companyid', $user->companyid) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address_1') ? 'is-invalid' : '' }}" name="address_1" id="address_1" required>{{ old('address_1', $user->address_1) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_state') ? 'is-invalid' : '' }}" type="text" name="region_state" id="region_state" value="{{ old('region_state', $user->region_state) }}" required>
