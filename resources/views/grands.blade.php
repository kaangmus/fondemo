...
<body>
  ...
  <section id="grands">
    ...
    <h1 class="text-center">USD <?php echo number_format($total); ?> FOCUSED ON NATURE GRANTS TO WILDLIFE CONSERVATION
      PROJECTS SINCE 2009</h1>
              ...
              <div class="content-right-container">
                ...
                <div class="content-right collapse" id="grants">
                  ...
                  <div class="species {{$specie->type}}">
                    ...
                    <p>
                      <a href="javascript:void(0)" class="company" data-toggle="modal"
                        data-target="#grands{{$uniq_ngo_id}}">
                        {{$yearKey}}
                      </a>
                      <div class="modal fade" id="grands{{$uniq_ngo_id}}" tabindex="-1" role="dialog"
              ...
              <div class="content-right-container">
                ...
                <div class="content-right collapse" id="year{{$mainyear->year}}">
                  ...
                  <div class="species {{$specie->type}}">
                    ...
                    <p>
                      <a href="javascript:void(0)" id="company" data-toggle="modal"
                        data-target="#modal{{$mainyear->year}}{{$sngo->id}}">
                        {{$sngo->name}}
                      </a>
                      <div class="modal fade" id="modal{{$mainyear->year}}{{$sngo->id}}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
